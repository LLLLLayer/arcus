...
All exporters share the off-screen `ParallaxRenderer.renderOffscreen` frame loop on the same figure-8 camera path, so trajectory work benefits all of them:
